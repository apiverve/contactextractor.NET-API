...
namespace APIVerve
{
    public class ContactExtractorAPIClient
    {
        ...
        public ContactExtractorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public ContactExtractorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(contactextractorQueryOptions options)
        {
            try
            {
                if (_isDebug)
